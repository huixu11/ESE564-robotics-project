...
\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --episodes 5 --save-video videos/class_panda_push_eval_5.gif --video-episodes 5}
\end{center}
...
Figure~\ref{fig:snapshots} shows snapshots from the generated five-task pushing video. The sequence illustrates the robot observing two objects, moving through the pushing behavior, and the target object entering the requested basket region. The full video file is included at \path{videos/class_panda_push_eval_5.gif}.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.19\linewidth]{figures/push_task_snapshot_0000.png}
\includegraphics[width=0.19\linewidth]{figures/push_task_snapshot_0060.png}
\includegraphics[width=0.19\linewidth]{figures/push_task_snapshot_0120.png}
\includegraphics[width=0.19\linewidth]{figures/push_task_snapshot_0220.png}
\includegraphics[width=0.19\linewidth]{figures/push_task_snapshot_0414.png}
\caption{Snapshots from the five-task MuJoCo pushing video artifact. The camera view shows the language command caption and the two colored YCB objects and basket regions.}
\label{fig:snapshots}
\end{figure}
...
\path{.\.venv\Scripts\python.exe scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --episodes 5 --save-video videos/class_panda_push_eval_5.gif --video-episodes 5}
