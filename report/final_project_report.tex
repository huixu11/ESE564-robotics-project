...
\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --instruction "place the cracker box in the left basket" --episodes 3}
\end{center}

Changing only the instruction string changes the selected object and basket:

\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --instruction "place the mustard bottle in the right basket" --episodes 3}
\end{center}
...
\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --episodes 20}
\end{center}

The contact-rich five-task video was generated with:

\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda_contact.yaml --policy push_fsm --episodes 5 --save-video videos/class_panda_contact_eval_5.gif --video-episodes 5}
\end{center}
...
\begin{table}[h]
\centering
\caption{Final perception-driven pushing results in the class Panda MuJoCo scene.}
\label{tab:results}
...
\path{.\.venv\Scripts\python.exe scripts/evaluate.py --config configs/class_panda_contact.yaml --policy push_fsm --episodes 5 --save-video videos/class_panda_contact_eval_5.gif --video-episodes 5}

\path{.\.venv\Scripts\python.exe scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --instruction "place the mustard bottle in the right basket" --episodes 3 --save-video videos/push_language_yellow_to_green.gif}
\end{center}
