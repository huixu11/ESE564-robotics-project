...
\begin{center}
\path{python scripts/evaluate.py --config configs/class_panda.yaml --policy push_fsm --episodes 50}
\end{center}
...
Table~\ref{tab:results} reports the final quantitative results. The 50-episode run includes both objects, both baskets, randomized object starts, and speed modifiers.
...
\midrule
Five-task video run & 5 & 5 & 100\% & 82.00 & 57--100 \\
Explicit cracker-to-left command & 3 & 3 & 100\% & 94.00 & 84--100 \\
Explicit mustard-to-right command & 3 & 3 & 100\% & 67.67 & 57--85 \\
Randomized evaluation & 50 & 45 & 90\% & 100.00 & 45--240 \\
\bottomrule
\end{tabular}
\end{table}
