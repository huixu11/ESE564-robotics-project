...
Experimental contact-rich TAMP grasp & 5 & 5 & 100\% & 298.20 & 225--341 \\
\bottomrule
\end{tabular}
\end{table}
...
The experimental TAMP grasp extension has its own video artifact at \path{videos/class_panda_grasp_contact_eval_5.mp4}, with the GIF version at \path{videos/class_panda_grasp_contact_eval_5.gif}. Figure~\ref{fig:grasp_tamp} shows still frames from the first contact-rich grasp episode. This figure is included to document the grasping direction, not to replace the contact-push result as the main physics evidence.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.19\linewidth]{figures/grasp_contact_snapshot_0000.png}
\includegraphics[width=0.19\linewidth]{figures/grasp_contact_snapshot_0045.png}
\includegraphics[width=0.19\linewidth]{figures/grasp_contact_snapshot_0080.png}
\includegraphics[width=0.19\linewidth]{figures/grasp_contact_snapshot_0115.png}
\includegraphics[width=0.19\linewidth]{figures/grasp_contact_snapshot_0145.png}
\caption{Still frames from the experimental contact-rich TAMP grasp video. The language caption specifies the command, and the policy executes a sampled grasp skeleton with a MuJoCo contact gripper before moving the selected object to the requested basket.}
...
.\.venv\Scripts\python.exe scripts\evaluate.py --config configs/class_panda_grasp.yaml --policy tamp_grasp --episodes 5 --save-video videos/class_panda_grasp_contact_eval_5.gif --video-episodes 5
\end{lstlisting}
